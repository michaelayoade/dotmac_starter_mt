...
FAMILIES: tuple[tuple[str, str], ...] = (
    ...
    # ADR-0036: positioning owns only location observations and rebuildable
    # projections. Keep this exact and before the broader field/inbox families;
    # map assets, GIS geometry, vehicles and business consequences stay with
    # their product-domain owners.
    (
        "positioning",
