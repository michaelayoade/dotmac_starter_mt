...
SUBSCRIPTIONS_SRC ?= packages/dotmac-subscriptions/src/dotmac_subscriptions
SALES_SRC ?= packages/dotmac-sales/src/dotmac_sales
...
type-check: ## mypy (assembly + kernel + UI + module packages)
	poetry run mypy app $(KERNEL_SRC) $(UI_SRC) $(MODULE_SRC) $(TICKETING_SRC) $(APPDIR_SRC) $(FILES_SRC) $(IMPORTS_SRC) $(APPROVALS_SRC) $(PEOPLE_SRC) $(DURABLE_TIMERS_SRC) $(ORDERS_SRC) $(INVENTORY_SRC) $(ASSETS_SRC) $(IPAM_SRC) $(NETWORK_INVENTORY_SRC) $(NETWORK_OBSERVABILITY_SRC) $(NETWORK_TOPOLOGY_SRC) $(NETWORK_ASSURANCE_SRC) $(NETWORK_CONTROL_SRC) $(FIBER_PLANT_SRC) $(NETWORK_ACCESS_SRC) $(PON_ACCESS_SRC) $(INTEGRATION_SRC) $(OIDC_SRC) $(CONNECTOR_WHATSAPP_SRC) $(CAMPAIGNS_SRC) $(BILLING_SRC) $(COLLECTIONS_SRC) $(SUBSCRIPTIONS_SRC) $(SALES_SRC) $(INBOX_SRC) $(SURVEYS_SRC) $(PROJECTS_SRC) $(WORK_ORDERS_SRC) $(POSITIONING_SRC) $(WEB_ANALYTICS_SRC) $(ANALYTICS_SRC)
security: ## Bandit security scan (assembly + kernel + UI + module packages)
	poetry run bandit -c pyproject.toml -r app $(KERNEL_SRC) $(UI_SRC) $(MODULE_SRC) $(TICKETING_SRC) $(APPDIR_SRC) $(FILES_SRC) $(IMPORTS_SRC) $(APPROVALS_SRC) $(PEOPLE_SRC) $(DURABLE_TIMERS_SRC) $(ORDERS_SRC) $(INVENTORY_SRC) $(ASSETS_SRC) $(IPAM_SRC) $(NETWORK_INVENTORY_SRC) $(NETWORK_OBSERVABILITY_SRC) $(NETWORK_TOPOLOGY_SRC) $(NETWORK_ASSURANCE_SRC) $(NETWORK_CONTROL_SRC) $(FIBER_PLANT_SRC) $(NETWORK_ACCESS_SRC) $(PON_ACCESS_SRC) $(INTEGRATION_SRC) $(OIDC_SRC) $(CONNECTOR_WHATSAPP_SRC) $(CAMPAIGNS_SRC) $(BILLING_SRC) $(COLLECTIONS_SRC) $(SUBSCRIPTIONS_SRC) $(SALES_SRC) $(INBOX_SRC) $(SURVEYS_SRC) $(PROJECTS_SRC) $(WORK_ORDERS_SRC) $(POSITIONING_SRC) $(WEB_ANALYTICS_SRC) $(ANALYTICS_SRC)
