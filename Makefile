...
APP_SYNC_SRC ?= packages/dotmac-app-sync/src/dotmac_app_sync
...
DOCUMENT_RENDERING_SRC ?= packages/dotmac-document-rendering/src/dotmac_document_rendering
