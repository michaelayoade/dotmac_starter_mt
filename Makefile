...
SERVICE_ACCESS_POLICY_SRC ?= packages/dotmac-service-access-policy/src/dotmac_service_access_policy
INBOX_OPERATIONS_SRC ?= packages/dotmac-inbox-operations/src/dotmac_inbox_operations
