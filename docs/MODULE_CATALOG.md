...
- **Owner:** Dotmac registered-domain lifecycle, desired registrar/DNS state, observation interpretation, reconciliation, holds and guarded release
- **Contract:** Tenant-only registered-domain lifecycle: registration/transfer/renewal intent and confirmation, immutable registrar observations, desired contact/nameserver/DNS state, reconciliation, holds and guarded release. NOT pricing, billing, collections policy, hosting, provider transport, credentials, TenantDomain, TLS or ingress.
