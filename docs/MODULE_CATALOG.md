...
| [`dotmac-deployment-foundation`](../packages/dotmac-deployment-foundation/README.md) | universal facility | [`adopted`](../packages/dotmac-deployment-foundation/EXTRACTION.toml) | n/a | — | — | not allowlisted | `0.3.0a4` | — | `dotmac_erp` | `dotmac_integrator`, `dotmac_starter_mt`, `dotmac_sub` |
...
| [`dotmac-kernel`](../packages/dotmac-kernel/README.md) | universal facility | [`historical-pre-rule`](../packages/dotmac-kernel/EXTRACTION.toml) | n/a | — | — | [dedicated workflow](../.github/workflows/release-kernel.yml) | `0.1.0a100+dev` | — | `dotmac_starter_mt` | `dotmac_academy_app`, `dotmac_erp`, `dotmac_sub`, `dotmac_vendor_control_plane` |
