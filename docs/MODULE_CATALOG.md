...
| [`dotmac-connector-nira`](../packages/dotmac-connector-nira/README.md) | stateless protocol adapter | [`in-progress`](../packages/dotmac-connector-nira/EXTRACTION.toml) | n/a | — | — | [connector allowlist](../.github/release-connectors.json) | `0.1.0a1` | — | — | `dotmac_domains`, `dotmac_integrator` |
...
- **Evidence:** `in-progress` from [`EXTRACTION.toml`](../packages/dotmac-connector-nira/EXTRACTION.toml); source mode `greenfield-after-inventory`.
- **Proven consumers:** —.
