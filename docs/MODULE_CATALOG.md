...
| [`dotmac-deployment-foundation`](../packages/dotmac-deployment-foundation/README.md) | universal facility | [`audit-complete`](../packages/dotmac-deployment-foundation/EXTRACTION.toml) | n/a | — | — | not allowlisted | `0.2.0a2` | — | — | `dotmac_erp`, `dotmac_integrator`, `dotmac_starter_mt`, `dotmac_sub` |
...
| [`dotmac-tax`](../packages/dotmac-tax/README.md) | optional module | [`adopted`](../packages/dotmac-tax/EXTRACTION.toml) | [tenant · `mod_tax`](../packages/dotmac-tax/src/dotmac_tax/manifest.py) | atomic (all declared planes) | not installed here | [module allowlist](../.github/release-modules.json) | `0.1.0a4` | `>=0.1.0a85` | `dotmac_erp` | `dotmac_sub` |
...
- **Evidence:** `audit-complete` from [`EXTRACTION.toml`](../packages/dotmac-deployment-foundation/EXTRACTION.toml); source mode `product-first`.
- **Proven consumers:** —.
- **Candidate consumers:** `dotmac_erp`, `dotmac_integrator`, `dotmac_starter_mt`, `dotmac_sub`.
...
- **Evidence:** `adopted` from [`EXTRACTION.toml`](../packages/dotmac-tax/EXTRACTION.toml); source mode `product-first`.
