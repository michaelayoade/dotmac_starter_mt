...
| [`dotmac-deployment-foundation`](../packages/dotmac-deployment-foundation/README.md) | universal facility | [`audit-complete`](../packages/dotmac-deployment-foundation/EXTRACTION.toml) | n/a | — | — | not allowlisted | `0.1.0a1` | — | — | `dotmac_erp`, `dotmac_integrator`, `dotmac_starter_mt`, `dotmac_sub` |
