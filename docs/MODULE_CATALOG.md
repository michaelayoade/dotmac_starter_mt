...
| [`dotmac-domains`](../packages/dotmac-domains/README.md) | optional module | [`audit-complete`](../packages/dotmac-domains/EXTRACTION.toml) | [tenant · `mod_domains`](../packages/dotmac-domains/src/dotmac_domains/manifest.py) | atomic (all declared planes) | not installed here | [module allowlist](../.github/release-modules.json) | `0.1.0a1` | `>=0.1.0a76` | — | `dotmac_cloud` |
| [`dotmac-hosting`](../packages/dotmac-hosting/README.md) | optional module | [`audit-complete`](../packages/dotmac-hosting/EXTRACTION.toml) | [tenant · `mod_hosting`](../packages/dotmac-hosting/src/dotmac_hosting/manifest.py) | atomic (all declared planes) | not installed here | [module allowlist](../.github/release-modules.json) | `0.1.0a1` | `>=0.1.0a77` | — | `dotmac_cloud` |
...
### [`dotmac-domains`](../packages/dotmac-domains/README.md)
...
- **Evidence:** `audit-complete` from [`EXTRACTION.toml`](../packages/dotmac-domains/EXTRACTION.toml); source mode `greenfield-after-inventory`.
- **Proven consumers:** —.
- **Candidate consumers:** `dotmac_cloud`.

### [`dotmac-hosting`](../packages/dotmac-hosting/README.md)

- **Owner:** Dotmac technical hosting specifications, hosting-account lifecycle, desired state, suspension/restoration, retention holds, business outcomes, observation interpretation and reconciliation
- **Contract:** Tenant-only provider-neutral hosting-account lifecycle behind `hosting.account.v1`. Integrator owns panel identity, credentials, wire transport, retries, checkpoints and health. Hosting V1 observes aggregate mailbox count only and does not own mailbox lifecycle, price, subscriptions, orders, collections policy, approval decisions, domains, websites or compute.
- **Evidence:** `audit-complete` from [`EXTRACTION.toml`](../packages/dotmac-hosting/EXTRACTION.toml); source mode `greenfield-after-inventory`.
- **Proven consumers:** —.
- **Candidate consumers:** `dotmac_cloud`.
