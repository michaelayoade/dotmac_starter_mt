...
| [`dotmac-connector-sub-accounting`](../packages/dotmac-connector-sub-accounting/README.md) | stateless protocol adapter | [`audit-complete`](../packages/dotmac-connector-sub-accounting/EXTRACTION.toml) | n/a | — | — | not allowlisted | `0.1.0a1` | — | — | `dotmac_erp`, `dotmac_integrator` |
