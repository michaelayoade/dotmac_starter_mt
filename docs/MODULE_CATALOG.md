...
| [`dotmac-deployment-foundation`](../packages/dotmac-deployment-foundation/README.md) | universal facility | [`adopted`](../packages/dotmac-deployment-foundation/EXTRACTION.toml) | n/a | — | — | not allowlisted | `0.3.0a2+dev` | — | `dotmac_erp` | `dotmac_integrator`, `dotmac_starter_mt`, `dotmac_sub` |
