...
| [`dotmac-orders`](../packages/dotmac-orders/README.md) | optional module | [`audit-complete`](../packages/dotmac-orders/EXTRACTION.toml) | [tenant · `mod_orders`](../packages/dotmac-orders/src/dotmac_orders/manifest.py) | atomic (all declared planes) | not installed here | not allowlisted | `0.1.0a1` | `>=0.1.0a70` | — | `dotmac_cloud`, `dotmac_sub` |
