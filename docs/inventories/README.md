...
| **Expenses sources** | ERP as the qualifying category, claim, receipt-policy, limit and approval-lifecycle source; CRM and Sub request/line and synchronization deltas; Backoffice's confirmed absence; the ownership split from Party, Approvals, Files and Finance; and the staged shadow/cutover retirement gates | `expenses-sources.md` |
