...
| **Fixed-asset accounting sources** | ERP as the only qualifying depreciation/impairment/revaluation source; the physical Assets versus Finance ownership boundary; parity behavior, tenant/transaction/accounting defects not ported; and ERP-first authority retirement | `finance-asset-accounting-sources.md` |
