...
| Web analytics sources | Fleet-wide first-party and provider-aggregate inventory, greenfield ruling, committed Starter implementation provenance, privacy/retention boundary, and Backoffice-first/Sub-second adoption evidence for `dotmac-web-analytics` | `web-analytics-sources.md` |
