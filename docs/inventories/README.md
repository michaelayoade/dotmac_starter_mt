...
| **Documents and Records sources** | the nine-repository audit separating controlled working documents from declared compliance records: ERP HR handbook as the Documents base, Sub immutable quote exports as the content-addressed delta, mutable LegalDocument rows as anti-sources, and the greenfield-after-inventory Records verdict | `documents-records-sources.md` |
