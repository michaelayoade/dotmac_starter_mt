...
| **Digital Media sources** | Mkt's narrow reusable Asset/creative relation as the product-first seed; a pinned ERP/Sub/CRM/Academy/Backoffice/Workspace/Vendor CP/Integrator negative audit proving no qualifying DAM; greenfield-after-inventory canaries for immutable revisions, rights, technical observations and renditions; and the exact Files/Content/Documents/Publishing/Media Observations/Records boundaries | `digital-media-sources.md` |
