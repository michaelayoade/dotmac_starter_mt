...
| `dotmac-publishing` | product-first from Mkt post-delivery lifecycle and partial-success behavior | Gate 1 is recorded RED at `a941c6975e5f49520c07608ba2c0fc4e7e6172a3`: 32 expected missing-package failures and 15 passes. Gate 2 may implement the frozen immutable-snapshot, attempt/observation, timer and typed-outbox contract before any release or adoption. |
