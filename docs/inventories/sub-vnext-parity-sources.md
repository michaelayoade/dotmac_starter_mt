...
**As of:** 2026-08-20
**Decision:** [ADR-0040](../adr/0040-sub-vnext-parity-capabilities-have-narrow-independent-owners.md)
...
| Fleet Control | Starter `packages/dotmac-deployment-control` 0.1.0a1, ADR-0057, rollout/observation unit tests and platform-isolation canary | No valid competing owner; Sub UISP reconciliation is device control, not application deployment control | **Adopt existing owner.** Never create `dotmac-fleet-control`; never duplicate kernel update authority. |
