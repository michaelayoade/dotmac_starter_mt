...
metering. The reusable `dotmac-orders` distribution now implements the
tenant-scoped order aggregate but remains audit-complete, unadopted, absent
from release lanes, and uncomposed in this reference assembly. The target
