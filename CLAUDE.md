...
- **Design system (`dotmac-ui`).** `packages/dotmac-ui/` (distribution
  ...
  and `dotmac_ui` still importing no Jinja. One component today
  (`empty_state`, 0.1.0a5); every other `.dmui-*` name stays reserved, because
  ADR-0006 § 5 forbids harvesting components that merely look alike.
