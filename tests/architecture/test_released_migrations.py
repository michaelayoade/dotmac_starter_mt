...
RELEASED_TAGS: dict[str, tuple[str, str, dict[str, str]]] = {
    ...
    # a9 adds finite replay-evidence retention and durable released-hold
    # history. The release workflow installed the exact wheel, registered its
    # manifest, verified all eleven migrations and then created this tag.
