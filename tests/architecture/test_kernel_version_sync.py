...
# allocated in a72. Media observations follows in a74 because immutable a73
# belongs to the caller-session transaction release. Campaigns consumes that
# newer a73 capability and therefore remains in CAPABILITY_RAISED_FLOORS.
