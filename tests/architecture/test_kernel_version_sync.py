...
#
# People, campaigns and expenses consume no kernel feature newer than their
# allocation release. Their required Party-person or consent/idempotency/outbox
# facilities are present by that release, so the allocation itself is the
# floor. If one adopts a newer capability, move its row to
# CAPABILITY_RAISED_FLOORS while retaining the allocation release as evidence.
LEDGER_ALLOCATION_RELEASES: dict[str, str] = {
    "dotmac-campaigns": "0.1.0a71",
    "dotmac-expenses": "0.1.0a72",
