...
LEDGER_ALLOCATION_RELEASES: dict[str, str] = {
    # ADR-0032's first-party web analytics module consumes no kernel facility
    # introduced after its own namespace allocation. a71 is therefore its real
    # floor, not a capability-raised exception.
