...
MIGRATION = ROOT / "migrations/versions/sa_0001_access_policy.py"
...
def test_manifest_and_secure_plane_are_exact() -> None:
    ...
    assert (
        ...
        module.db_schema,
    ) == ("service_access_policy", "svc_access", "sa", "mod_svc_access")
    ...
    for name in module.tables:
        ...
        assert table.schema == "mod_svc_access"
...
def test_root_migration_declares_the_whole_forced_rls_plane() -> None:
    ...
    assert ast.literal_eval(assigned["revision"]) == "sa_0001_access_policy"
    ...
    for table in module.tables:
        qualified = f"mod_svc_access.{table}"
