...
class TestTheExtractionDossierIsHonest:
    ...
    def test_it_claims_no_adoption_it_does_not_have(
        ...
        """The defect ADR-0031 seals against: a module that has never run in a
        product database has no adoption evidence, and recording one it does not
        have is worse than recording none."""
        # The evidence ladder's zero-consumer rung: the audit IS complete;
        # what has not happened is a cutover.
