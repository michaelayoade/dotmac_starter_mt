...
def test_rehearsal_1_fresh_empty_assembly(scratch_db: str) -> None:
    ...
    assert _versions(scratch_db) == {"0015_open_value_types"}
...
def _simulate_v08(url: str) -> None:
    ...
    # repairs.
    assert _versions(url) == {"0015_open_value_types"}
...
def test_rehearsal_7_expected_heads_per_lineage() -> None:
    ...
    assert kernel_head.revision == "0015_open_value_types"
