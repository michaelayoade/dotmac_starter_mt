...
def test_the_shipped_ledger_is_the_host_owners_plus_allocated_modules() -> None:
    ...
    # than adding another due-work engine. `procurement` (ADR-0038) is the
    # fourteenth and tenant-only: none of the audited products names a
    # control-plane purchaser. None of these allocations installs behaviour in
    # the kernel.
