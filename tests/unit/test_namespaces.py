...
def test_the_shipped_ledger_is_the_host_owners_plus_allocated_modules() -> None:
    ...
    # than adding another due-work engine. Banking, tax and payroll are the next
    # three and remain mutually independent tenant-only financial owners. None
    # of these allocations installs behaviour in the kernel.
