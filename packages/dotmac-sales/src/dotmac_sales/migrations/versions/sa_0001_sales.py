...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("tax_total", sa.Numeric(20, 6), nullable=False),
        ...
        *_timestamps(),
        ...
        sa.CheckConstraint(
            "jsonb_typeof(fulfillment_eligibility_requirement_refs) = 'array' "
            "AND jsonb_array_length(fulfillment_eligibility_requirement_refs) > 0",
            name="ck_sales_quotes_eligibility_requirements",
        ),
        sa.CheckConstraint(
    ...
    op.create_table(
        ...
        sa.Column("price_version_ref", sa.String(240), nullable=False),
        sa.Column("terms_ref", sa.String(240), nullable=False),
        sa.Column("terms_snapshot", postgresql.JSONB(), nullable=False),
        sa.Column("specification_ref", sa.String(240), nullable=False),
        sa.Column("tax_rates", postgresql.JSONB(), nullable=False),
        sa.Column("tax_components", postgresql.JSONB(), nullable=False),
        *_timestamps(),
