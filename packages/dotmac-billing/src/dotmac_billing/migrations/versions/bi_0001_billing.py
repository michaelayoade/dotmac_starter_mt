...
def _position_columns() -> list[Any]:
    return [
        ...
        sa.Column("rebuild_fingerprint", sa.String(64), nullable=False),
        sa.Column("source_authority", sa.String(40), nullable=False),
        sa.Column("projection_mode", sa.String(24), nullable=False),
        sa.Column("derived_from", sa.String(32), nullable=False),
        sa.Column("completeness", sa.String(32), nullable=False),
        sa.Column("completeness_reason_code", sa.String(120)),
        sa.Column("financial_state", sa.String(32), nullable=False),
        sa.Column("observed_at", sa.DateTime(timezone=True), nullable=False),
        _created_at(),
        sa.CheckConstraint(
            "currency = upper(currency) AND length(currency) = 3",
...
def _exposure_columns() -> list[Any]:
    return [
        sa.Column("billing_account_id", sa.Uuid(), nullable=False),
        sa.Column("document_id", sa.Uuid(), nullable=False),
        sa.Column("source_owner", sa.String(120), nullable=False),
        ...
        sa.CheckConstraint(
            "currency = upper(currency) AND length(currency) = 3",
            name="ck_exposure_currency",
        ),
        sa.CheckConstraint(
            "minor_units BETWEEN 0 AND 6", name="ck_exposure_minor_units"
        ),
    ]
...
def _upgrade_tenant_plane() -> None:
    ...
    op.create_table(
        ...
        *_obligation_columns(),
        ...
        sa.ForeignKeyConstraint(
            ...
            [
                "mod_billing.billing_accounts.tenant_id",
                "mod_billing.billing_accounts.id",
            ],
        ...
        sa.ForeignKeyConstraint(
            ...
            [
                "mod_billing.rated_obligations.tenant_id",
                "mod_billing.rated_obligations.id",
            ],
        ...
        *_document_columns(),
        ...
        sa.ForeignKeyConstraint(
            ...
            [
                "mod_billing.rated_obligations.tenant_id",
                "mod_billing.rated_obligations.id",
                "mod_billing.rated_obligations.billing_account_id",
            ],
        ...
        sa.ForeignKeyConstraint(
            ...
            [
                "mod_billing.documents.tenant_id",
                "mod_billing.documents.id",
                "mod_billing.documents.billing_account_id",
            ],
    ...
    op.create_table(
        ...
        *_line_columns(),
        ...
        sa.ForeignKeyConstraint(
            ...
            ["mod_billing.documents.tenant_id", "mod_billing.documents.id"],
        ...
        sa.ForeignKeyConstraint(
            ...
            [
                "mod_billing.documents.tenant_id",
                "mod_billing.documents.id",
                "mod_billing.documents.obligation_id",
            ],
    ...
    op.create_table(
        ...
        *_group_columns(),
        ...
        sa.ForeignKeyConstraint(
            ...
            [
                "mod_billing.posting_groups.tenant_id",
                "mod_billing.posting_groups.id",
                "mod_billing.posting_groups.billing_account_id",
            ],
    ...
    op.create_table(
        ...
        *_allocation_columns(),
        ...
        sa.ForeignKeyConstraint(
            ...
            [
                "mod_billing.confirmed_settlements.tenant_id",
                "mod_billing.confirmed_settlements.id",
                "mod_billing.confirmed_settlements.billing_account_id",
            ],
        ...
        sa.ForeignKeyConstraint(
            ...
            [
                "mod_billing.allocation_effects.tenant_id",
                "mod_billing.allocation_effects.id",
                "mod_billing.allocation_effects.billing_account_id",
            ],
    ...
    op.create_table(
        ...
        *_artifact_columns(),
        ...
        sa.ForeignKeyConstraint(
            ...
            [
                "mod_billing.invoice_document_facts.tenant_id",
                "mod_billing.invoice_document_facts.id",
                "mod_billing.invoice_document_facts.document_id",
                "mod_billing.invoice_document_facts.fact_version",
            ],
        ...
        sa.ForeignKeyConstraint(
            ...
            [
                "mod_billing.document_artifacts.tenant_id",
                "mod_billing.document_artifacts.id",
                "mod_billing.document_artifacts.document_fact_id",
                "mod_billing.document_artifacts.media_type",
            ],
    ...
    op.create_table(
        ...
        *_accounting_fact_columns(),
        ...
        sa.ForeignKeyConstraint(
            ...
            ["mod_billing.posting_groups.tenant_id", "mod_billing.posting_groups.id"],
        ...
        sa.ForeignKeyConstraint(
            ...
            [
                "mod_billing.accounting_facts.tenant_id",
                "mod_billing.accounting_facts.id",
            ],
    ...
    op.create_table(
        ...
        sa.Column("tenant_id", sa.Uuid(), nullable=False),
        *_exposure_columns(),
        _tenant_fk("fk_receivable_exposure_facts_tenant"),
        sa.ForeignKeyConstraint(
            ["tenant_id", "document_id", "billing_account_id"],
            [
                "mod_billing.documents.tenant_id",
        ...
        sa.UniqueConstraint(
            "tenant_id", "id", name="uq_receivable_exposure_facts_tenant_id_id"
        ),
        sa.UniqueConstraint(
            "tenant_id",
            "source_owner",
    ...
    op.execute(
        "ALTER TABLE mod_billing.receivable_exposure_facts ENABLE ROW LEVEL SECURITY;"
    )
    op.execute(
        "ALTER TABLE mod_billing.receivable_exposure_facts FORCE ROW LEVEL SECURITY;"
    )
    op.execute(
        """
        CREATE POLICY receivable_exposure_facts_tenant_isolation ON mod_billing.receivable_exposure_facts
        USING (tenant_id = public.app_current_tenant_id())
        WITH CHECK (tenant_id = public.app_current_tenant_id());
        """
    )
    ...
    op.execute(
        "GRANT SELECT, INSERT ON mod_billing.receivable_exposure_facts TO app_user;"
    )
    op.execute(
        """
        CREATE TRIGGER receivable_exposure_facts_append_only
        BEFORE UPDATE OR DELETE ON mod_billing.receivable_exposure_facts
        FOR EACH ROW EXECUTE FUNCTION mod_billing.refuse_mutation();
        """
    )
    op.execute(
...
def _upgrade_platform_plane() -> None:
    ...
    op.create_table(
        ...
        *_obligation_columns(),
        sa.ForeignKeyConstraint(
            ["billing_account_id"],
            ["mod_billing.platform_billing_accounts.id"],
            name="fk_platform_rated_obligations_account",
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["supersedes_obligation_id"],
            ["mod_billing.platform_rated_obligations.id"],
    ...
    op.create_table(
        ...
        *_document_columns(),
        ...
        sa.ForeignKeyConstraint(
            ...
            [
                "mod_billing.platform_rated_obligations.id",
                "mod_billing.platform_rated_obligations.billing_account_id",
            ],
        ...
        sa.ForeignKeyConstraint(
            ...
            [
                "mod_billing.platform_documents.id",
                "mod_billing.platform_documents.billing_account_id",
            ],
    ...
    op.create_table(
        ...
        *_line_columns(),
        ...
        sa.ForeignKeyConstraint(
            ...
            [
                "mod_billing.platform_documents.id",
                "mod_billing.platform_documents.obligation_id",
            ],
    ...
    op.create_table(
        ...
        *_group_columns(),
        ...
        sa.ForeignKeyConstraint(
            ...
            [
                "mod_billing.platform_posting_groups.id",
                "mod_billing.platform_posting_groups.billing_account_id",
            ],
    ...
    op.create_table(
        ...
        *_allocation_columns(),
        ...
        sa.ForeignKeyConstraint(
            ...
            [
                "mod_billing.platform_confirmed_settlements.id",
                "mod_billing.platform_confirmed_settlements.billing_account_id",
            ],
        ...
        sa.ForeignKeyConstraint(
            ...
            [
                "mod_billing.platform_allocation_effects.id",
                "mod_billing.platform_allocation_effects.billing_account_id",
            ],
    ...
    op.create_table(
        ...
        *_artifact_columns(),
        sa.ForeignKeyConstraint(
            ...
            [
                "mod_billing.platform_invoice_document_facts.id",
                "mod_billing.platform_invoice_document_facts.document_id",
                "mod_billing.platform_invoice_document_facts.fact_version",
            ],
        ...
        sa.ForeignKeyConstraint(
            ...
            [
                "mod_billing.platform_document_artifacts.id",
                "mod_billing.platform_document_artifacts.document_fact_id",
                "mod_billing.platform_document_artifacts.media_type",
            ],
    ...
    op.create_table(
        ...
        *_accounting_fact_columns(),
        ...
        sa.ForeignKeyConstraint(
            ["reverses_fact_id"],
            ["mod_billing.platform_accounting_facts.id"],
    ...
    op.execute(
        "REVOKE ALL ON mod_billing.platform_receivable_exposure_facts FROM app_user;"
    )
    op.execute(
    ...
    op.execute(
        "GRANT SELECT, INSERT ON mod_billing.platform_receivable_exposure_facts TO platform_api;"
    )
    op.execute(
        """
        CREATE TRIGGER platform_receivable_exposure_facts_append_only
        BEFORE UPDATE OR DELETE ON mod_billing.platform_receivable_exposure_facts
        FOR EACH ROW EXECUTE FUNCTION mod_billing.refuse_mutation();
        """
    )
    op.execute(
