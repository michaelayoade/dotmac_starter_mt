...
**Released: `0.1.0a1` through `0.1.0a8`; a9 is declared, not yet published.**
Releases a2–a4 implement SPI 1.1; a5–a8 implement SPI 1.2. See `CHANGELOG.md`,
which is the authority on what has and has not shipped. a8 adds indexed,
revisioned shadow-comparison evidence.
