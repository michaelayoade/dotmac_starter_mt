...
`32482276827`. Publication is supply-chain evidence only; it composes no product
and moves no authority.

- Adds the tenant-only `mod_netctrl` lineage (`nc` revision prefix).
- Owns provider-neutral command intent, approval, dispatch, execution evidence,
