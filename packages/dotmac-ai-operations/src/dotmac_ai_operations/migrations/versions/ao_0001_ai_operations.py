...
revision = "ao_0001_ai_operations"
down_revision = None
branch_labels = ("ai_operations",)
...
def upgrade() -> None:
    ...
    op.execute("CREATE SCHEMA IF NOT EXISTS mod_aiops;")
    op.execute("GRANT USAGE ON SCHEMA mod_aiops TO app_user, app_admin;")
    op.create_table(
        "ai_policies",
        *_tenant_columns(),
        ...
        sa.UniqueConstraint("tenant_id", "id", name="uq_ai_policies_tenant_id_id"),
        sa.UniqueConstraint("tenant_id", "code", name="uq_ai_policies_code"),
        schema=_SCHEMA,
    )
    op.create_table(
        "ai_policy_versions",
        *_tenant_columns(),
        ...
        sa.Column("allowed_operation_kinds", postgresql.JSONB(), nullable=False),
        sa.Column("input_contract_ref", sa.String(240), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["tenant_id", "policy_id"],
            ["mod_aiops.ai_policies.tenant_id", "mod_aiops.ai_policies.id"],
            ondelete="RESTRICT",
        ),
        sa.UniqueConstraint(
            "tenant_id", "id", name="uq_ai_policy_versions_tenant_id_id"
        ),
        sa.UniqueConstraint(
    ...
    op.create_table(
        ...
        *_tenant_columns(),
        ...
        sa.Column("input_ref", sa.String(240), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ...
            [
                "mod_aiops.ai_policy_versions.tenant_id",
                "mod_aiops.ai_policy_versions.id",
            ],
            ondelete="RESTRICT",
        ),
        sa.UniqueConstraint("tenant_id", "id", name="uq_ai_operations_tenant_id_id"),
        sa.UniqueConstraint("tenant_id", "operation_key", name="uq_ai_operations_key"),
        schema=_SCHEMA,
    )
    op.create_table(
        ...
        *_tenant_columns(),
        ...
        sa.Column("attempt_key", sa.String(200), nullable=False),
        sa.Column("observation_digest", sa.String(64), nullable=False),
        sa.Column("outcome", sa.String(24), nullable=False),
        sa.Column("output_ref", sa.String(240)),
        sa.Column("output_digest", sa.String(64)),
        sa.Column("provider_observation", sa.String(160)),
        sa.Column("model_observation", sa.String(160)),
        sa.Column("request_observation", sa.String(200)),
        ...
        sa.ForeignKeyConstraint(
            ...
            ["mod_aiops.ai_operations.tenant_id", "mod_aiops.ai_operations.id"],
            ondelete="RESTRICT",
        ),
        sa.UniqueConstraint(
    ...
    op.create_table(
        ...
        *_tenant_columns(),
        ...
        sa.UniqueConstraint("tenant_id", "id", name="uq_ai_insights_tenant_id_id"),
        sa.UniqueConstraint("tenant_id", "insight_key", name="uq_ai_insights_key"),
        schema=_SCHEMA,
    )
    for table in (
        "ai_policies",
